...
Memory is a markdown file (`MEMORY.md`) that gives Rout persistent context about you. It's injected into every Claude prompt as a system-level context block, so the AI knows your name, your preferences, your family, your routines — without you repeating yourself.
